                ...
                <Link to={!user && "/login"}>
                    <div className="header_option" onClick={handleAuthentication}>
                        <span className="header_optionLineOne">
                            Hello <strong className="helloUser">{user ? user?.email : "Guest"}</strong>
                        </span>
